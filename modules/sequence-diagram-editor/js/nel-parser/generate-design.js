...
var traverseTree = function (node, model, view) {
    ...
    if (node.type === "Resource") {
        ...
        model.addChild(sourcePoint, messageOptionsOutbound);
        ...
        var position = new GeoCore.Models.Point({
            x: model.attributes.centerPoint.x() - 100,
            y: model.attributes.centerPoint.y() - 100
        });
        ...
        view.model.attributes.diagramResourceElements.models[0].addChild(processor);
    }
};
